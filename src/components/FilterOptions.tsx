...
export function FilterOptions() {
	return (
		<form class="bg-zinc-800 p-4 rounded-lg border border-zinc-700 flex flex-col gap-2">
			<label for="pages" class="uppercase font-bold tracking-wide text-sm text-zinc-300">páginas</label>
			<div class="flex gap-2 items-center">
				...
				/>
				<span class="font-mono flex-shrink-0 w-12 text-sm text-center bg-zinc-700 text-zinc-300 p-1 rounded-md">{store.filters.pages}</span>
			</div>
			<label for="genre" class="uppercase font-bold tracking-wide text-sm text-zinc-300">género</label>
			<select
				id="genre"
